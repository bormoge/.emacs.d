...
Check differences in files              diff, diff-buffers, diff-buffer-with-file, ediff, ediff-buffers
...
Measure execution time of function      benchmark, benchmark-run, benchmark-run-compiled
...
Org occur (Search regexp)               org-occur                       CTRL + c / /, CTRL + c / r
...
Rotate values                           calc-roll-down, calc-roll-up    CTRL + i, CTRL + ALT + i
